...
// Typed variants for framer-motion custom prop
    ...
    return (
        <div className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative z-20 text-center p-6">
                ...
                >
                    Transform your enterprise data into an intelligent, highly-contextual
                    AI assistant. Powered by advanced RAG architectures and zero-latency
                    embedding engines.
                </motion.p>
                ...
                >
                    <Link
                        to="/register"
                        className="group px-8 py-4 bg-white text-black font-semibold rounded-full shadow-lg hover:bg-gray-200 transition-colors duration-300 flex items-center gap-2"
                    >
                    ...
                    <Link
                        to="/login"
                        className="inline-flex h-14 items-center justify-center rounded-full border border-white/20 bg-white/5 px-8 font-medium text-white backdrop-blur-md transition-all hover:bg-white/10"
                    >
