...
import { UploadCloud, FileText, FileCode, Image, FileSpreadsheet } from "lucide-react";
                                ...
                                {status === "idle" || status === "dragging" ? (
                                    ...
                                    >
                                        ...
                                        <div className="mb-6 space-y-2 text-center">
                                            <h3 className="font-bold text-gray-900 text-2xl tracking-tight dark:text-white">
                                                Drop your files here
                                            </h3>
                                            <p className="text-gray-400 text-sm dark:text-gray-500 max-w-[280px] mx-auto">
                                                Fast and secure document processing for your knowledge base.
                                            </p>

                                            <div className="flex items-center justify-center gap-4 mt-6 opacity-40 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300">
                                                ...
                                                <div className="flex flex-col items-center gap-1">
                                                    ...
                                                    <span className="text-[10px] uppercase font-bold tracking-widest">XLSX</span>
                                                </div>
                                                <div className="flex flex-col items-center gap-1">
                                                ...
                                                <div className="flex flex-col items-center gap-1">
                                                    ...
                                                    <span className="text-[10px] uppercase font-bold tracking-widest">IMG</span>
                                                </div>
                                                <div className="flex flex-col items-center gap-1">
                                                    <FileText className="h-5 w-5" />
                                                    <span className="text-[10px] uppercase font-bold tracking-widest">TXT</span>
                                                </div>
                                            </div>
                                        </div>

                                        <button
                                            className="group flex items-center justify-center gap-2 rounded-full bg-blue-500 px-6 py-2 font-semibold text-white text-sm transition-all duration-200 hover:bg-blue-600 shadow-lg shadow-blue-500/25"
