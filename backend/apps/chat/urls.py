...
urlpatterns = [
    ...
    path("sessions/<uuid:session_id>/messages/", SendMessageView.as_view(), name="chat-send-message"),
    path("messages/<uuid:message_id>/feedback/", MessageFeedbackView.as_view(), name="message-feedback"),
    path("messages/<uuid:message_id>/favorite/", ToggleFavoriteView.as_view(), name="message-favorite"),
    # Phase 3
    ...
    path("saved-searches/<uuid:pk>/", SavedSearchDetailView.as_view(), name="saved-search-detail"),
    path("export/session/<uuid:session_id>/", ExportChatView.as_view(), name="export-chat"),
